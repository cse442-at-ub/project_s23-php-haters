...
$sql = "SELECT task, due_date, email FROM tasks WHERE (due_date BETWEEN '$reminder_due_date_1' AND '$reminder_due_date_2') OR (due_date BETWEEN '$reminder_due_date_2' AND '$reminder_due_date_3')";
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    $message = "This is a reminder that you have a task, $task_title, due on $task_due_date.";
    // sending the email
