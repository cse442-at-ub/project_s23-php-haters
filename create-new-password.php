...
//                ?>
        <form action="reset-request.php" method="post">
            ...
            <input style="margin-left: 30%" type="password" name="pwd" placeholder="Enter a new password">
            <br>
            <input style="margin-left: 30%" type="password" name="pwd-repeat" placeholder="Repeat the new password">
            <br>
